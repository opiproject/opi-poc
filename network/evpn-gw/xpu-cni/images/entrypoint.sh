...
XPU_BIN_FILE="/usr/bin/xpu"

# Give help text for parameters.
usage()
{
    printf "This is an entrypoint script for XPU CNI to overlay its\n"
...
for i in $CNI_BIN_DIR $XPU_BIN_FILE
do
  if [ ! -e "$i" ]; then
