...
- Setup
  ...
  - [Physical Testbed Setup](physical-testbed.md)
    - [100G Switch - Arista DCS-7280CR](./hardware/A100G/README.md)
    - [Network PDU - Vertiv VP7N3001](./hardware/nPDU/README.md)
    - [KVM Switch - Avocent MPU8032DAC](./hardware/KVM/README.md)
    - [Serial Consoles - Avocent ACS8000](./hardware/TS/README.md)
